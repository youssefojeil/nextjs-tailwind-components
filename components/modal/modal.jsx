                ...
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="mt-2">
                    <p className="text-sm text-gray-500">
                      ...
                      Repudiandae eos debitis non, aliquam doloremque animi vel
                      deleniti eius architecto, ab ipsum ex explicabo enim
                      suscipit tempora nobis temporibus quia laudantium?
                    </p>
                  </div>
